...
/**
 * @brief Configures a CTRE CanCoder with only the fields provided.  All other
...
/**
 * @brief Configures a CTRE CanCoder with configuration values according to
